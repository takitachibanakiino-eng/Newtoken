...
VERIFY_EXPIRE_1 = int(os.environ.get('VERIFY_EXPIRE_1', 84600))
VERIFY_EXPIRE_2 = int(os.environ.get('VERIFY_EXPIRE_2', 84600))

# Gap time between first and second verification (in seconds, default 30 mins)
VERIFY_GAP_TIME = int(os.environ.get('VERIFY_GAP_TIME', 43000))
...
try:
    ADMINS=[7547485758]
    for x in (os.environ.get("ADMINS", "7547485758 1327021082").split()):
        ADMINS.append(int(x))
except ValueError:
